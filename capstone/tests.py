...
class ProfileTestCase(TestCase):
    def setUp(self):
        ...
        self.profile = Profile.objects.create(user=self.user, first_name='John', last_name='Doe', bio='I am a software engineer', phone_number='1234567890', email='johndoe@email.com', github='johndoe', frontend=True, backend=True, database=True, profile_picture='johndoe.jpg')
...
class ViewsTestCase(TestCase):
    def setUp(self):
        self.client = Client()
        self.user = User.objects.create(username='johndoe', password='password123', email='johndoe@email.com')
        self.profile = Profile.objects.create(user=self.user, first_name='John', last_name='Doe', bio='I am a software engineer', phone_number='1234567890', email='johndoe@email.com', github='johndoe', profile_picture='johndoe.jpg')
        self.project = Project.objects.create(user=self.user, title='My Project', description='This is my project', frontend=True, backend=True, database=True, github='johndoe/myproject', link_to_live_demo='https://github.com/johndoe/myproject', image='myproject.jpg')
